...
from .custom_eval_fun import default_compute_score as custom_compute_score
...
def default_compute_score(
    ...
    if data_source == "openai/gsm8k":
        ...
        res = aug_gsm8k.compute_score(solution_str, ground_truth)
        ...
        res = olympiad.compute_score(solution_str, ground_truth, extra_info)
...
__all__ = ["default_compute_score", "custom_compute_score"]
