...
project_name='verl_grpo_my_gsm8k'
exp_name='llama3_1_8b_aug_grpo_1104'

project_name='verl_aug_grpo'
exp_name='llama3_1_8b_gsm8k_ours_keep_gen_1117'
...
# meta_trainer.scene_generator.api_url=http://152.136.41.186:30131/v1/chat/completions
# meta_trainer.scene_generator.api_url=http://localhost:8001/v1/chat/completions
# meta_trainer.scene_generator.model_name=deepseek-v3.1t
# /sharedata/zhangzitian/models/Qwen2.5-3B-Instruct
    # exp.setting=run_vanilla_grpo_baseline \


python3 -m verl.c1_trainer.main_ppo \
    meta_trainer.outer_loop_repeat=3 \
    meta_trainer.scene_generator.api_url=http://172.31.211.169:8001/v1/chat/completions \
    meta_trainer.scene_generator.api_key=sk-kQKMTKyEQA7X6eZ_AR72Cqvb2o7NgskyrKG9UdPqUPD8zu-_HeVs5Nie0_M \
    meta_trainer.scene_generator.model_name=llama3.1-8b \
